# 자재 API 인수 테스트 결과 — 2026-09-13T03-28-02

서버 http://localhost:3004 · as-of 2026-06-01 · 데이터 접두 AT7JPT · FW_DATA_DIR C:\Users\je310\AppData\Local\Temp\claude\D--factory-world-master\cf599f60-41cc-444e-840e-c30525cfb9ad\scratchpad\fw-accept-legacy · readonly=false

**합계 84 — PASS 83 · FAIL 0 · BLOCK 0 · NOTE 1**

| # | 구분 | 검사 | 판정 | 기대 | 실제 | ms |
|---|---|---|---|---|---|---:|
| AT-00 | 0 | 토큰 없이 summary → 401 | **PASS** | 401 | 401 {"error":"인증이 필요합니다."} | 35 |
| AT-01 | 0 | POST /api/login (관리자) → 토큰 | **PASS** | 200 token | role=admin | 30 |
| AT-02 | 0 | GET summary 응답 키 (items·classes·bomHeaders·bomLines·lots·check) | **PASS** | items,classes,bomHeaders,bomLines,lots,check | ["items","classes","bomHeaders","bomLines","lots","processMaterial","itemsByKind","phantoms","tmpItems","check","schema"] | 4 |
| AT-10 | 1 | import-sample #1 → ok · expectedMatch true · mismatches [] | **PASS** | expectedMatch true | {"status":200,"expectedMatch":true,"mismatches":[],"counts":{"uom":5,"uom_conv":1,"mat_class":24,"mat_class_leaf":18,"item":60,"item_by_type":{"CN":6,"FG":1,"PK":1,"PT":40,"RM":2,"SA":10},"item_phantom":3,"trace_mode":{" | 17 |
| AT-11 | 1 | import-sample.check = {D-8:10, R-10:10} | **PASS** | {D-8:10,R-10:10} | {"D-8":10,"R-10":10} |  |
| AT-12 | 1 | import-sample #2 (멱등) → summary 건수·counts 동일 | **PASS** | 동일 | {"s1":{"items":60,"classes":24,"bomHeaders":11,"bomLines":59,"lots":0,"check":{"D-8":10,"R-10":10}},"s2":{"items":60,"classes":24,"bomHeaders":11,"bomLines":59,"lots":0,"check":{"D-8":10,"R-10":10}},"counts2":{"uom":5,"u | 14 |
...
| AT-21 | 2 | classes 24 · 최상위 6 · 말단 18 · itemCount 합 60 | **PASS** | 24/6/18/60 | {"n":24,"roots":6,"leaves":18,"itemSum":60} | 2 |
| AT-22 | 2 | items 60 · isTmp 3 (TMP-) | **PASS** | 60 / 3 | {"n":60,"tmp":["TMP-FS7023","TMP-PK0010","TMP-SC1010P"],"byKind":{"CN":6,"FG":1,"PK":1,"PT":40,"RM":2,"SA":10}} | 2 |
| AT-22b | 2 | items[].kind 값이 §10 열거(FG/SA/PHANTOM/PART/RAW/PKG) 안인가 | **NOTE** | FG/SA/PHANTOM/PART/RAW/PKG | ["CN","FG","PK","PT","RM","SA"] |  |
| AT-23 | 2 | items?kind=PHANTOM → 3 (HA-3000·EX-5000·PE-6000) | **PASS** | 3 | ["EX-5000","HA-3000","PE-6000"] | 1 |
...
| AT-30 | 3 | bom/BLDC-500W-48V totals = EA 76 · g 221 · SHT(매) 12 · kg 0.85 · m 0.5 | **PASS** | {"EA":76,"g":221,"SHT":12,"kg":0.85,"m":0.5} | {"EA":76,"kg":0.85,"g":221,"SHT":12,"m":0.5} | 3 |
...
| AT-34 | 3 | depth=1 → 완성품 직하 10 (서브어셈블리 9 + PK-0010) | **PASS** | 10 · level 1 | {"n":10,"pns":["SA-1000","RA-2000","HA-3000","PE-6000","FS-7010","FS-7020","GB-8000","PL-9000","EX-5000","TMP-PK0010"]} | 2 |
...
| AT-44 | 4 | where-used/NO-SUCH → 404 (500 아님) | **PASS** | 404 | 404 | 1 |
...
| AT-53 | 5 | process/OP-ZZ → 404 | **PASS** | 404 | 404 | 1 |
| AT-54 | 5 | GET /api/admin/bop (기존 계약) → summary.inputs 46 · parts 59 · OP-B90 inputCount 9 · processes 24 | **PASS** | 46/59/9/24 | {"summary":{"processes":24,"parts":59,"inputs":46,"linked":0,"unlinked":["OP-A10","OP-A20","OP-A30","OP-A40","OP-A50","OP-A60","OP-A70","OP-A80","OP-A90","OP-A100","OP-B10","OP-B20","OP-B30","OP-B40","OP-B50","OP-B60","O | 1 |
| AT-55 | 5 | GET check (있으면) → details D-8 10건 = 미배정 목록 | **PASS** | 10 | ["BLDC-500W-48V > FS-7010","BLDC-500W-48V > FS-7020","BLDC-500W-48V > GB-8000","BLDC-500W-48V > PL-9000","SA-1000 > IP-1040","SA-1000 > LC-1080","FS-7020 > TMP-FS7023","FS-7020 > FS-7021","FS-7020 > FS-7022","FS-7020 > O | 3 |
...
| AT-65b | 6 | DELETE items/:pn → 거부 (405/400, R-11) | **PASS** | 405\|400 | 405 {"error":"R-11: item 은 삭제하지 않는다 — PUT 으로 status=OBSOLETE 로 전환"} | 1 |
| AT-66a | 6 | POST items (대체 자석 시험 품목) → 200/201 | **PASS** | 201 | 201 {"ok":true,"created":true,"item":{"itemId":181,"pn":"AT7JPT-PM-X","name":"대체 자석(시험)","nameKo":null,"spec":null,"kind":"PT","classId":11,"classCode":"PT-MAG","className":"영구자석","uom":"EA","uomSymbol":"EA","status":"AC | 2 |
...
| AT-66d | 6 | 대체품 우선순위 2 → 201 (동시 유효 허용) | **PASS** | 201 | 201 {"ok":true,"line":{"id":60,"lineId":60,"headerId":5,"lineNo":60,"parentPn":"RA-2000","parentName":"Rotor Assy","pn":"AT7JPT-PM-X","name":"대체 자석(시험)","kind":"PT","phantom":false,"qtyPer":8,"uom":"EA","qtyBasis":"NET", | 2 |
...
| AT-67b | 6 | DRAFT rev B → 201 (ECO 준비 허용) | **PASS** | 201 | 201 {"ok":true,"header":{"id":12,"pn":"PL-9000","parentPn":"PL-9000","parentName":"Parking Lock Assy","bomType":"PROD","altNo":"00","rev":"B","baseQty":1,"baseUom":"EA","status":"DRAFT","effFrom":"2026-01-01","effTo":"99 | 2 |
...
| AT-70 | 7 | PL-9000 에 2027-01-01 부터 유효한 라인 추가 → 201 | **PASS** | 201 | 201 {"ok":true,"line":{"id":61,"lineId":61,"headerId":11,"lineNo":50,"parentPn":"PL-9000","parentName":"Parking Lock Assy","pn":"AT7JPT-ASOF","name":"as-of 시험 품목","kind":"PT","phantom":false,"qtyPer":1,"uom":"EA","qtyBas | 2 |
...
| AT-80 | 8 | POST lots 코일 입고 로트 850 kg (POSCO / MS-8842) → 201 | **PASS** | 201 id | 201 {"ok":true,"lot":{"id":1,"lotNo":"AT7JPT-LOT-SC1011-A","pn":"SC-1011","name":"규소강판 원소재","kind":"LOT","parentLotId":null,"parentLotNo":null,"qty":850,"qtyInit":850,"uom":"kg","status":"AVAILABLE","statePmId":null,"sta | 2 |
| AT-81 | 8 | 분할 서브로트 0.85 kg (parentLotId) → 201 · 원로트 잔량 849.15 (D-17 차감) | **PASS** | 201 / 849.15 / init 850 | {"status":201,"qty":849.15,"qtyInit":850,"text":"{\"ok\":true,\"lot\":{\"id\":2,\"lotNo\":\"AT7JPT-SUB-001\",\"pn\":\"SC-1011\",\"name\":\"규소강판 원소재\",\"kind\":\"SUBLOT\",\"parentLotId\":1,\"parentLotNo\":\"AT7JPT-LOT-SC1 | 2 |
| AT-81b | 8 | 잔량보다 큰 분할 → 400 (D-17) | **PASS** | 400 | 400 {"error":"D-17: 부모 로트 잔량(849.15)보다 큰 수량은 분할할 수 없습니다."} | 1 |
| AT-82 | 8 | consume: SC-1010P 로트 ← 서브로트 0.85 kg @OP-A10 → 201 · 서브로트 잔량 0/CONSUMED | **PASS** | 201 / 0 | 201 {"ok":true,"genId":1,"outLot":{"id":3,"lotNo":"AT7JPT-LOT-SC1010P-7","pn":"TMP-SC1010P","name":"Stator Lamination (블랭킹편)","kind":"LOT","parentLotId":null,"parentLotNo":null,"qty":80,"qtyInit":80,"uom":"SHT","status": | 2 |
| AT-83 | 8 | 계보 4단 등록 (SC-1010P → SC-1010 → SA-1000 → 시리얼) → 201 | **PASS** | 201 | 201 {"ok":true,"genId":4,"outLot":{"id":6,"lotNo":"AT7JPT-SN-000481","pn":"BLDC-500W-48V","name":"BLDC 모터 500W 48V","kind":"SERIAL","parentLotId":null,"parentLotNo":null,"qty":1,"qtyInit":1,"uom":"EA","status":"AVAILABLE | 2 |
| AT-84 | 8 | genealogy fwd (코일 → 시리얼): SC-1011·SC-1010P·SC-1010·SA-1000·BLDC 전부 도달 · 시리얼 1 | **PASS** | 5품목 · SERIAL 1 | {"reach":["SC-1011","SC-1010P","SC-1010","SA-1000","BLDC-500W-48V"],"serial":["AT7JPT-SN-000481"]} | 1 |
...
| AT-87 | 8 | lots?pn=SC-1011 → 이번 실행 로트 2 (원로트 + 서브로트) | **PASS** | 2 | [["AT7JPT-SUB-001",0,"CONSUMED"],["AT7JPT-LOT-SC1011-A",849.15,"AVAILABLE"]] | 1 |
...
| AT-93 | 9 | 응답 시간 — 전개·역전개·요약·품목·공정·bop 각 < 1,000 ms | **PASS** | < 1000 | [["/bom/BLDC-500W-48V?asOf=2026-06-01",3],["/where-used/BF-3040",1],["/summary",2],["/items",1],["/process/OP-B90",2],["/api/admin/bop",1]] |  |
